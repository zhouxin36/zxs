 ...
 * <p>
 * VM设置：-Xms41m -Xmx41m -Xmn10m -XX:+UseParallelGC -XX:+PrintGCDetails -XX:+PrintFlagsFinal
 * <p>
 * -Xms41m：堆最小值 -Xmx41m：堆最大值 -Xmn10m：新生代大小大小(推荐 3/8) -XX:+UseParallelGC：使用并行收集器
 * <p>
 * 初始化时：835k(堆内存) 第一次add：3907k 第二次add：6979k 第三次add: eden + survivor1 = 9216k < 6979k +
 * 3072k,区空间不够，开始 YGC YGC  6979k -> 416k(9216k) 表示年轻代 GC前为6979，GC后426k.年轻代总大小9216k
 *
 * jps
 * jinfo
 * jstat
